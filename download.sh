...
unzip skip_s50.zip -d embeddings && mv embeddings/skip_s50.txt embeddings/word2vec_50.txt
rm skip_s50.zip
echo "Done!!!"
...
unzip skip_s100.zip -d embeddings && mv embeddings/skip_s100.txt embeddings/word2vec_100.txt
rm skip_s100.zip
echo "Done!!!"
...
unzip skip_s300.zip -d embeddings && mv embeddings/skip_s300.txt embeddings/word2vec_300.txt
rm skip_s300.zip
echo "Done!!!"
...
unzip skip_s50.zip -d embeddings && mv embeddings/skip_s50.txt embeddings/fasttext_50.txt
rm skip_s50.zip
echo "Done!!!"
...
unzip skip_s100.zip -d embeddings && mv embeddings/skip_s100.txt embeddings/fasttext_100.txt
rm skip_s100.zip
echo "Done!!!"
...
unzip skip_s300.zip -d embeddings && mv embeddings/skip_s300.txt embeddings/fasttext_300.txt
rm skip_s300.zip
echo "Done!!!"
...
unzip skip_s50.zip -d embeddings && mv embeddings/skip_s50.txt embeddings/wang2vec_50.txt
rm skip_s50.zip
echo "Done!!!"
...
unzip skip_s100.zip -d embeddings && mv embeddings/skip_s100.txt embeddings/wang2vec_100.txt
rm skip_s100.zip
echo "Done!!!"
...
unzip skip_s300.zip -d embeddings && mv embeddings/skip_s300.txt embeddings/wang2vec_300.txt
rm skip_s300.zip
echo "Done!!!"
